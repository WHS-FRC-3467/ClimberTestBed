...
public class TwinTalonFXMech implements Sendable {
    ...
    public TwinTalonFXMech (int leftTalonID, int rightTalonID) {
		...
		m_rightMaster.setStatusFramePeriod(StatusFrame.Status_12_Feedback1, 20, ClimberConstants.kTimeoutMs);
		m_rightMaster.setStatusFramePeriod(StatusFrame.Status_13_Base_PIDF0, 20, ClimberConstants.kTimeoutMs);
