...
public class ClimberSubsystem extends SubsystemBase {
  ...
  DoubleSolenoid m_fixedClimberPiston = new DoubleSolenoid(9, PneumaticsModuleType.CTREPCM, PHConstants.FixedClimberForwardSoleniod, PHConstants.FixedClimberReverseSoleniod);
  DoubleSolenoid m_extenedingClimberPiston = new DoubleSolenoid(9, PneumaticsModuleType.CTREPCM, PHConstants.ExtendingClimberForwardSoleniod, PHConstants.ExtendingClimberReverseSoleniod);
